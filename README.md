...
Added layout for showcasing shipping container classes, selecting them to edit and adding new ones.
...
Updated layout with a way to select shipping container class for the product.
...
Preview: <http://deadtype.ca/newdistrict/admin_login.html> 
